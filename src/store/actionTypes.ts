...
import * as createCardActions from "src/store/createCard/actions";
...
export type allActionsTypes = ActionTypesInfer<
    typeof authActions | typeof boardActions | typeof listActions | typeof cardActions | typeof createCardActions
>;
